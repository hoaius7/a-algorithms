...
class A07CharacterReplacement {
	...
	public static void main(String[] args) {
		System.out.println(A07CharacterReplacement.findLength("aabccbb", 2));
		System.out.println(A07CharacterReplacement.findLength("abbcb", 1));
		System.out.println(A07CharacterReplacement.findLength("aabc", 1));
	}
}
